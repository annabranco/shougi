...
const JUMP_FORWARD_LEFT = { x: 2, y: 1 };
const JUMP_FORWARD_RIGHT = { x: 2, y: -1 };

const ALL_FORWARD = { x: BOARD_SIZE, y: 0 };
const ALL_BACK = { x: -BOARD_SIZE, y: 0 };

const ALL_LEFT = { x: 0, y: -BOARD_SIZE };

const ALL_RIGHT = { x: 0, y: BOARD_SIZE };
